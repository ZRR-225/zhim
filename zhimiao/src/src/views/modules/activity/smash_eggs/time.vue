...
<!--      <el-form-item>
      ...
      <el-form-item>
		  <!-- v-if="isAuth('sys:masksuperprizetime:save')" -->
	...
	<el-form>
		<table  style="width:100%;line-height:40px;text-align:center;">           
			...
			<tr>
				<td>{{dataForm.prizePool}}</td>
				<td>{{dataForm.prizeNumbser}}</td>
			</tr>  
		</table>
	</el-form>
    <el-table
	  ...
	  <el-table-column
        ...
        label="状态">
			<template slot-scope="scope">
				<el-tag v-if="scope.row.status ===0" size="small">关闭</el-tag> 
      ...
      getDataList () {
        ...
        this.$http({
          ...
          if (data && data.code === 0) {
				...
				this.dataForm.prizePool=data.prizePool
