...
<!--    <el-form-item label="奖品ID铃铛" prop="prizeId">
      <el-input v-model="dataForm.prizeId" placeholder="奖品ID铃铛"></el-input>
    </el-form-item> -->
    <el-form-item label="奖品" prop="prizeId">
		<el-select v-model="dataForm.prizeId" placeholder="请选择" style="width:225px">
		<el-option
