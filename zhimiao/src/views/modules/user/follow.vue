	...
	<div class="follow">
		...
		style="width:100%;">
		  ...
		  <el-table-column
			...
			width="150">
			  <template slot-scope="scope">
				<el-button  v-if="isAuth('sys:userfollow:queryfollowdetailed')" type="text" size="small" @click="addOrUpdateHandle(scope.row.userCode)">查看</el-button>
			  </template>
		  </el-table-column>
		</el-table>
		<el-pagination
	...
	export default{
		...
		methods:{
			getDataList(){
				...
				this.$http({
				  url: this.$http.adornUrl('/sys/userfollow/queryuserfollow'),
				  method: 'get',
